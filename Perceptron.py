def perceptron():
    ...
    with mlflow.start_run():
        ...
        accuracy = perceptron1.score(X_test, y_test) * 100
        ...
        if tracking_url_type_store != "file":
            mlflow.sklearn.log_model(perceptron1, "model", registered_model_name="PerceptronDefault")
        else:
            mlflow.sklearn.log_model(perceptron1, "model")
